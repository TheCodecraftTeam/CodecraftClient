...
import modifedLibraries.rockscode.util.Matrix4f;
import modifedLibraries.rockscode.util.Vector3f;
...
public class Matrix4f {
	...
	public Matrix4f initPerspective(float fov, float aspectRatio, float zNear,
			float zFar) {
