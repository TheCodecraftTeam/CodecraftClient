package modifedLibraries.rockscode.util;
...
import modifedLibraries.rockscode.util.Texture;
import modifedLibraries.rockscode.util.Vector2f;
...
public class GLText {
	...
	public void draw(float x, float y,float z) {
		...
		glBegin(GL_QUADS);
			...
			glTexCoord2f(1,0);
			GL11.glVertex3f(x+size.x,y,z);
			glTexCoord2f(1,1);
			GL11.glVertex3f(x+size.x,y+size.y,z);
			glTexCoord2f(0,1);
			GL11.glVertex3f(x,y+size.y,z);
		glEnd();
