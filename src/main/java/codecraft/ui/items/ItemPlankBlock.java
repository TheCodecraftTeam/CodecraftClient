...
import codecraft.world.blocks.BlockLeave;
...
public class ItemPlankBlock extends Item {
	public ItemPlankBlock() {
	...
	try {
		World.SetBlockAtPosition((int)blockPosition.x, (int)blockPosition.y,(int)blockPosition.z, BlockPlank.class);
	...
	public void draw(float x, float y, float z, float size) {
		glBegin(GL_QUADS);
		GL11.glTexCoord2f(0.0f+ 0.5f,0.0f); GL11.glVertex3f(-(0.5f*size) + x, -(0.5f*size) +y ,  (0.5f*size) +  +z);	// Bottom Left Of The Texture and Quad
		GL11.glTexCoord2f(0.1f+ 0.5f,0.0f); GL11.glVertex3f( (0.5f*size) + x, -(0.5f*size) +y ,  (0.5f*size) +z);	// Bottom Right Of The Texture and Quad
		GL11.glTexCoord2f(0.1f+ 0.5f, 0.1f); GL11.glVertex3f( (0.5f*size) + x, (0.5f*size) +y ,  (0.5f*size) +z);	// Top Right Of The Texture and Quad
		GL11.glTexCoord2f(0.0f+ 0.5f, 0.1f); GL11.glVertex3f(-(0.5f*size) + x, (0.5f*size) +y ,  (0.5f*size) +z);	// Top Left Of The Texture and Quad
		// Back Face
